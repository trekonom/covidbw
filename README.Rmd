...
Besides the data the repository contains some visualitions made in the [R programming language](https://www.r-project.org) using the data viz package [ggplot2](https://ggplot2.tidyverse.org).

![](figure/covid_bar_bw_2021-11-28.png)

![](figure/covid_map_bw_2021-11-28.png)

An [interactive map](https://www.datawrapper.de/_/x5nV3/) created with  [Datawrapper](https://www.datawrapper.de) could be found [here](https://www.datawrapper.de/_/x5nV3/).
